...
// 2. Class
class ShowPostLA extends Component {
  constructor () {
    super()
      ...
      <Fragment>
        <div className='show-post' style={showPostStyle}>
          <div className='col-10 mx-auto mb-5'>
            <Link className='text-black mb-3' to={'/la-posts/'}> <h5> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
...
// 3. Exports
export default withRouter(ShowPostLA)
