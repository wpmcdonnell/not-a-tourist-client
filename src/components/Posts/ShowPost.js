...
class ShowPost extends Component {
  ...
  render () {
    ...
    if (deleted) {
      ...
      return <Redirect to={'/posts/' + this.props.match.params.id + '/img-post-update'}/>
      ...
      <Fragment>
        <div className='show-post' style={showPostStyle}>
          <div className='mx-auto mb-5'>
            <Link className='text-black mb-3' to={'/posts/'}> <h5> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
