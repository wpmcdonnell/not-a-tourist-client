...
// 2. Class
class ShowPostTYO extends Component {
  constructor () {
    super()
  ...
  render () {
    ...
    if (deleted) {
      ...
      return <Redirect to={'/tokyo-posts/' + this.props.match.params.id + '/update'}/>
    } else if (toUpdatePicture) {
      return <Redirect to={'/tokyo-posts/' + this.props.match.params.id + '/img-post-update'}/>
...
// 3. Exports
export default withRouter(ShowPostTYO)
