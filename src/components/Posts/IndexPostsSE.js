...
// 2. The class
class IndexPostsSE extends Component {
              ...
              <Card.Body>
                <Card.Title>
                  ...
                  <div className='d-inline'>
                    ...
                    <Link className='d-inline col-md-3 mx-auto' to={{ pathname: `/se-posts/${post._id}`, data: post.type }}>{post.title}</Link>
                  </div>
                </Card.Title>
